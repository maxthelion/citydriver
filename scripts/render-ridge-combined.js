#!/usr/bin/env bun
/**
 * render-ridge-combined.js — Direction + elevation + slope band segmentation.
 *
 * Combines all three criteria: gradient direction (30°), elevation proximity
 * (100m from seed), and steepness bands (flat <0.3, moderate 0.3-0.8, steep >0.8).
 *
 * Usage: bun scripts/render-ridge-combined.js <seed> <gx> <gz> [outDir]
 */
...
const outDir = process.argv[5] || 'experiments/019g-output';
...
console.log('Segmenting terrain (30° dir + 100m elev + slope bands [0.3, 0.8])...');
...
const header = `P6\n${W} ${H}\n255\n`;
const basePath = `${outDir}/ridge-combined-seed${seed}`;
