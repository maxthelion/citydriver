#!/usr/bin/env bun
/**
 * Experiment 007s5 — Overlay using zone boundary polygon edges as anchor roads:
 *
...
const outDir = process.argv[5] || 'experiments/007s5-output';
...
// Sort by length descending, take two longest
triEdges.sort((a, b2) => b2.length - a.length);
let edges = triEdges.slice(0, 2);
