#!/usr/bin/env bun
/**
 * render-ridge-elev-bands.js — Direction + elevation band segmentation.
 *
 * Splits terrain by gradient direction (30°) AND elevation proximity (100m
 * from seed). A steep hill and gentle coast pointing the same way get
 * separate faces if they're >100m apart in elevation.
 *
 * Usage: bun scripts/render-ridge-elev-bands.js <seed> <gx> <gz> [outDir]
 */
...
const outDir = process.argv[5] || 'experiments/019e-output';
...
console.log('Segmenting terrain (30° dir + 100m elev bands)...');
...
const header = `P6\n${W} ${H}\n255\n`;
const basePath = `${outDir}/ridge-elev-bands-seed${seed}`;
