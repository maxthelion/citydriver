 ...
 * Tick 5: Reserve land for non-residential uses (archetype-driven)
 * Tick 6: Ribbon layout — place parallel streets within zones
 * Tick 7: Connect zone spines to skeleton network
 */
