...
export const ARCHETYPES = {
  marketTown: {
    ...
    growth: {
      ...
      agents: {
        commercial:         { share: 0.12, budgetPerTick: 0.03, minFootprint: 10,
                              seedCount: 8, minSpacing: 30, noise: 0.1 },
        industrial:         { share: 0.08, budgetPerTick: 0.02, minFootprint: 50,
                              seedCount: 2, minSpacing: 80, noise: 0.1 },
        civic:              { share: 0.05, budgetPerTick: 0.01, minFootprint: 20,
                              seedCount: 4, minSpacing: 40, noise: 0.05 },
        openSpace:          { share: 0.08, budgetPerTick: 0.02, minFootprint: 30,
                              seedCount: 3, minSpacing: 50, noise: 0.1 },
        agriculture:        { share: 0.15 },
        residentialFine:    { share: 0.30, budgetPerTick: 0.06, minFootprint: 5,
                              seedCount: 12, minSpacing: 10, noise: 0.25 },
        residentialEstate:  { share: 0.10, budgetPerTick: 0.03, minFootprint: 40,
                              seedCount: 3, minSpacing: 60, noise: 0.1 },
        residentialQuality: { share: 0.12, budgetPerTick: 0.03, minFootprint: 15,
                              seedCount: 5, minSpacing: 30, noise: 0.15 },
      },
    },
  },
