  ...
  marketTown: {
    ...
    growth: {
      ...
      agents: {
        ...
        industrial: {
          share: 0.08, spreadBehaviour: 'scored',
          footprint: [500, 5000], minSpacing: 500,
          affinity: { edgeness: 0.5, downwindness: 0.6, developmentProximity: 0.3 },
          seedsPerTick: 3,
        },
        civic: {
          share: 0.05, spreadBehaviour: 'scored',
          footprint: [200, 1500], minSpacing: 200,
          affinity: { centrality: 0.7, roadFrontage: 0.3, developmentProximity: 0.5 },
          seedsPerTick: 3,
        },
        openSpace: {
          share: 0.08, spreadBehaviour: 'scored',
          footprint: [200, 3000], minSpacing: 200,
          affinity: { waterfrontness: 0.3, edgeness: 0.4, developmentProximity: 0.3 },
          seedsPerTick: 3,
        },
        agriculture: {
          share: 0.15, spreadBehaviour: 'belt',
          footprint: [50, 200], minSpacing: 50,
          affinity: { edgeness: 1.0 },
          seedsPerTick: 0,
        },
        residentialFine: {
          share: 0.30, spreadBehaviour: 'organic',
          footprint: [50, 3000], minSpacing: 0,
          affinity: { centrality: 0.3, roadFrontage: 0.3, developmentProximity: 0.8 },
          seedsPerTick: 20,
        },
        residentialEstate: {
          share: 0.10, spreadBehaviour: 'scored',
          footprint: [300, 5000], minSpacing: 300,
          affinity: { edgeness: 0.5, developmentProximity: 0.3 },
          seedsPerTick: 3,
        },
        residentialQuality: {
          share: 0.12, spreadBehaviour: 'scored',
          footprint: [100, 3000], minSpacing: 100,
          affinity: { waterfrontness: 0.4, industrialDistance: 0.6, developmentProximity: 0.5 },
          seedsPerTick: 5,
        },
      },
    },
